...
import Login from './Auth/Login';    // adjust the path if different
import Signup from './Auth/Signup'; 

const LandingPage = () => {
    const navigate = useNavigate();

    const [openAuthModal, setOpenAuthModel] = useState(true);
    const [currentPage, setCurrentPage] = useState("login");

    const handleCTA = () => {
        navigate("/builder"); // optional, route to resume builder page
    };
